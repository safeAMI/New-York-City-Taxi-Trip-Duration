...
\begin{slide}{Project Introduction}
  \begin{center}
    \begin{figure}
    \includegraphics[scale=0.4]{figures/one.eps}
    \end{figure}
  \end{center}
\begin{center}
\twotonebox{\rotatebox{90}{Intro}}{\parbox{.90\textwidth}
{Data Fields for This Project
\begin{itemize}
\item \textcolor{green}{id, vendor_id, store_and_fwd_flag, passenger_count}
\item \textcolor{red}{pickup_datetime,dropoff_datetime}
\item \textcolor{red}{pickup_longitude,pickup_latitude,dropoff_longitude,dropoff_latitude}
\item \textcolor{blue}{trip_duration}
\end{itemize}
}}
...
\begin{slide}[toc=,bm=]{}
  \begin{itemize}
    \item pickup_datetime:
      \begin{itemize}
        \twocolumn{
          \item \begin{figure}\includegraphics[scale=0.4]{figures/12.eps}\end{figure}  
        }{
          \item \begin{itemize}
          \item It can be seen from the figure that the day of the month will affect the taxi trip turation.
...
\begin{slide}[toc=,bm=]{}
  \begin{itemize}
    \item Ridge
    \item\begin{figure}\includegraphics[scale=0.3]{figures/19.eps}\end{figure}
    \item Xgboost
    \item\begin{figure}\includegraphics[scale=0.3]{figures/20.eps}\end{figure}
  \end{itemize}
\end{slide}
%%==========================================================================================
%%
